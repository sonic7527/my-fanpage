  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-5 left-4 z-50 flex min-h-14 items-center gap-2 rounded-full bg-[#06C755] px-4 text-white shadow-[0_12px_32px_rgba(6,199,85,0.32)] transition-all duration-300 hover:bg-[#05b84f] hover:-translate-y-0.5 active:translate-y-0 focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-white sm:bottom-6 sm:left-6 sm:px-5"
