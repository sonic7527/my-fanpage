...
export default function LineQrButton() {
  ...
  const lineUrl = process.env.NEXT_PUBLIC_LINE_OA_URL || "https://line.me/R/ti/p/@777xvkrg";
  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-5 left-4 z-50 flex min-h-14 items-center gap-2 rounded-full border border-line/50 bg-line px-4 text-line-ink shadow-[0_16px_40px_oklch(0.08_0.02_249/0.4)] transition-transform duration-300 hover:-translate-y-0.5 active:translate-y-0 focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-line sm:bottom-6 sm:left-6 sm:px-5"
      ...
      >
        ...
        <span className="text-sm font-black tracking-wide">LINE 諮詢</span>
      </button>
      ...
      {open && (
        <>
          ...
          {/* Panel */}
          <div className="fixed bottom-24 left-6 z-50 w-[calc(100vw-3rem)] max-w-72 rounded-[0.5rem_1.5rem_0.5rem_1.5rem] border border-gold/20 bg-surface p-5 shadow-2xl animate-fade-up md:p-6">
            ...
            <a
              ...
              className="flex min-h-11 w-full items-center justify-center gap-2 rounded-full bg-line px-4 py-2.5 text-sm font-bold text-line-ink transition-transform hover:-translate-y-0.5"
            >
