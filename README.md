...
### 2026-03-21
- Logo 全面更新：使用螢光橘新 logo，去黑底透明化，加入宋體中文字「北大液晶儀表維修」+ 英文 + 漸變五星裝飾線
- 導航列 Logo 放大（h-28 → h-44）
- 頁尾 Logo 放大（h-12 → h-28）
- 頁尾 Facebook 圖示連結至粉專、LINE 連結至官方帳號
- Logo 中文字修正「儀」字，裁切圖案+重新加正確文字

### 2026-03-20
- 聯繫方式改為僅 LINE，移除 Telegram 和網站聊天
- 屏東地址全站更新 539巷76號→78號（門牌更換）
- 小幫手快速鍵「可維修車種」改為「維修地點」，更新屏東地址為78號
